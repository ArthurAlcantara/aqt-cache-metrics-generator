/*
 ...
 for class br.com.bb.aqt.models.ListenerSchemaImpl
...
/*@org.infinispan.protostream.annotations.AutoProtoSchemaBuilder(
   className = "ListenerSchemaImplImpl",
   schemaFileName = "ListenerSchemaImpl.proto",
   schemaFilePath = "",
...
public class ListenerSchemaImplImpl extends br.com.bb.aqt.models.ListenerSchemaImpl implements org.infinispan.protostream.GeneratedSchema {

   private static final String PROTO_SCHEMA = "// File name: ListenerSchemaImpl.proto\n" +
   "// Generated from : br.com.bb.aqt.models.ListenerSchemaImpl\n" +
   "\n" +
   "syntax = \"proto2\";\n" +
   "\n" +
   "package METRICS;\n" +
   ...
   @Override
   public String getProtoFileName() { return "ListenerSchemaImpl.proto"; }
